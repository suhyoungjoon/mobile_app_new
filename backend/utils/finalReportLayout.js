...
/** 첫 페이지: 맨 아래 "인싸이트아이 고객센터 02-1668-5343" 줄 위에 성명/아파트명/동호수/전화번호 + 담당소장·팀장 서명란 추가 (흰색 덮기 없음) */
const FIRST_PAGE = {
  /** 고객센터 줄 위 블록: 성명/아파트명/동호수/전화번호 (y는 PDF 기준, 페이지 하단이 0). 글자 20% 확대, 위 4줄·왼쪽 5글자 위치 */
  footerBlock: {
    x: 45,
    lineHeight: 26,
    fontSize: 13,
    /** 첫 줄(성명) y — 위로 4줄 올림(185+88) */
    firstLineY: 273
  },
  /** 담당소장·팀장 서명란 (footerBlock 바로 아래, 동일하게 위·왼쪽 조정) */
  signature: {
    lineLength: 120,
    lineYOffset: 8,
    fontSize: 12,
